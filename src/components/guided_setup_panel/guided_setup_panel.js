...
const GuidedSetupPanel = ({
  ...
  return (
    <>
      ...
      {!!guideOpen && (
        <div
          style={{ position: 'relative', background: '#000', height: '700px' }}>
          <EuiFlyout
            ownFocus
            onClose={() => setIsFlyoutVisible(false)}
            aria-labelledby="dsadsad">
            <EuiFlyoutHeader hasBorder>
              <EuiTitle size="m">
                <h2 id="dsadsa">A typical flyout</h2>
              </EuiTitle>
            </EuiFlyoutHeader>
            <EuiFlyoutBody>
              <EuiText>
            ...
            <>
                  ...
                  {endGuide ? (
                    <div>
                      ...
                      <p css={endGuide && mountedStyle}>
                        You’ve completed the Guide. Feel free to come back to
                        the Guides for more onboarding help or a refresher.
                      </p>
                    </div>
                  ) : (
                    <p>{data.intro}</p>
              ...
              <EuiFlyoutFooter css={panelFooterBg}>
                <EuiFlexGroup alignItems="center" justifyContent="center">
                  ...
                  <EuiText
                    size="xs"
                    style={{ color: euiTheme.colors.disabled }}>
                    |
                  </EuiText>
                  <EuiButtonEmpty
                    iconType="faceHappy"
